...
* **core:** drop the local echo defaults, the accent bug is upstream ([791551b](https://github.com/TheHefty/jvsl.env.agents.code-server/commit/791551b34eb82f969771eab3ebd26819be4da642))
